...
(() => {
  ...
  link.rel = 'stylesheet';
  link.href = 'home-compact.css?v=20260907-1035';
  link.dataset.homeCompact = 'true';
  link.dataset.homeCompactVersion = '20260907-1035';
  ...
  const attach = () => {
    ...
    if (ready) {
      if (!document.querySelector('script[data-home-compact-layout]')) {
        ...
        layoutScript.src = 'home-compact.js?v=20260907-1035';
...
(() => {
  ...
  const script = document.createElement('script');
  script.src = 'daily-thought.js?v=20260907-1035';
