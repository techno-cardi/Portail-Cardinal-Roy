...
test('le halo se relance sur plusieurs ressources sans recharger la page', async ({ page }) => {
  ...
  await expect(first).toHaveClass(/portal-search-flash/);
...
test('le halo se relance aussi quand on change de catégorie', async ({ page }) => {
  ...
  await expect(firstHeading).toHaveClass(/portal-search-flash/);
  ...
  await expect(secondHeading).toHaveClass(/portal-search-flash/);
  ...
  await expect(firstHeading).not.toHaveClass(/portal-search-flash/);
});
